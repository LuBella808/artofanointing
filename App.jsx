  ...
  return (
    <div className="bg-ivory text-ink font-sans">
      ...
      <section ref={heroRef} className="relative h-screen w-full overflow-hidden">
        <motion.div style={{ scale: heroScale }} className="absolute inset-0">
          <video className="w-full h-full object-cover" autoPlay muted loop playsInline preload="metadata"
            ...
            <source src="/video/983b5ef947d04385b17d563f51c0e41c.HD720p2.1Mbps42525527.mp4" type="video/mp4" />
          </video>
        </motion.div>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        <VideoBg
          src="/video/Professional_Mode_She_brings_her_hands_to_her_face_1.mp4"
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-12 grid md:grid-cols-2 gap-12 items-center py-24">
          ...
          <FadeUp delay={0.2}>
            <div className="relative">
              <img src="/images/lucinda-candle.jpg" alt="Lucinda Rae"
      ...
      <section id="the-apothecary" className="bg-ivory py-28 px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 mt-14">
            {[
              { name: 'BLESSING', sub: 'Sacred Perfume & Ritual Oil', price: '$58', desc: 'For the woman who needs to remember she is beloved. Luminous. Gentle. An anointing of grace.', img: '/images/oil-blessing.jpg', time: 'Morning' },
              { name: 'NECTAR', sub: 'Sensual Ritual Oil', price: '$60', desc: 'For the woman who has forgotten she is alive in her body. Warm. Honeyed. An anointing for the senses.', img: '/images/oil-nectar.jpg', time: 'Midday' },
              { name: 'TEMPLE', sub: 'Evening Ritual Oil', price: '$77', desc: 'For the sacred closing of the day. Deep. Still. A prayer for what you are releasing.', img: '/images/oil-temple.jpg', time: 'Evening' },
            ].map((oil, i) => (
          ...
          <FadeUp delay={0.1}>
            <div className="mt-20 relative rounded-sm overflow-hidden min-h-[420px] flex items-end">
              <img src="/images/covenant.jpg" alt="Covenant Botanical Perfume"
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-14 items-center">
          <FadeUp>
            <div className="flex justify-center">
              <div className="relative">
                <img src="/images/book-cover.jpg" alt="The Art of Anointing book cover"
      ...
      <section id="listen" className="relative py-28 px-6 overflow-hidden">
        <VideoBg
          src="/video/5015B1AE5B404B10B5544462D2D10EEC.mp4"
      ...
      <section id="email" className="relative py-28 px-6 overflow-hidden">
        <VideoBg
          src="/video/WhatsApp_Video_20250624_at_20.51.15_11b883ad.mp4"
